...
import javax.swing.JFrame; // The Window that will be displayed
...
public class Main {
    ...
    private static JFrame getDisplayWindow() {
        ...
        displayWindow.setSize(400, 400); // set the window's default size
    ...
    public static void main(String[] args) {
        ...
        displayWindow.add(new Painter()); // displays the graphic drawing
    }
}
