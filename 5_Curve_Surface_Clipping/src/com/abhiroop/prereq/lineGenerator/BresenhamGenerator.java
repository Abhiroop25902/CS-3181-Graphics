...
public class BresenhamGenerator{
    public static DrawForm generate(int x1, int y1, int x2, int y2) {
    ...
    public static DrawForm generate(Point start, Point end) {
        return generate(start.x, start.y, end.x, end.y);
    }
}
